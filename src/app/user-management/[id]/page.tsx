...
// import { fetchPayments, fetchTrainings } from '@/lib/data';
...
//     setProfile({ ...profile, banned: newStatus });
...
//           <button
//             onClick={toggleBan}
//             className={`px-3 py-2 rounded flex gap-2 text-sm ${
//               profile.banned
//                 ? 'bg-green-600'
//                 : 'bg-yellow-600'
//             }`}
...
//             <span
//               className={
//                 profile.banned ? 'text-red-400' : 'text-green-400'
//               }
//             >
